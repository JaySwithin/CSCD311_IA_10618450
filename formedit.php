...
<html lang="en">
  ...
  <body>
    ...
    <?php
      $mysqli = new mysqli('localhost','root','','addstud') or die(mysqli_error($mysqli));
          ...
          <?php
            ...
            <tr>
             ...
             <!--  <td><?php echo $row['age']; ?></td>
              ...
              <td>
                <a href="formedit.php?edit=<?php echo $row['id'];?>" class="btn btn-info">Edit</a>
    ...
    <div class="row justify-content-center">
      <form class="" action="process.php" method="POST">
          ...
          <div class="form-group">
            <label for="">age</label>
            <input class="form-control" type="num" name="age" placeholder="Enter your age" value="<?php echo $age; ?>">
          </div>
          <div class="form-group">
            <label for="">sex</label>
